...
2. 选择需要创建TApp的【业务】下相应的【命名空间】，展开【工作负载】下拉项，进入【TApp】管理页面。如下图所示：
   ![](https://github.com/tkestack/tke/blob/master/docs/images/tapp-1.png?raw=true)
...
当“运行/期望Pod数量”相等时，即表示 TApp 下的所有 Pod 已创建完成。
    ![](https://github.com/tkestack/tke/blob/master/docs/images/tapp-2.png?raw=true)
...
2. 选择需要更新的【业务】下相应的【命名空间】，展开【工作负载】列表，进入【TApp】管理页面。在需要更新 YAML 的 TApp 行中，单击【更多】>【编辑YAML】，进入“更新 TApp” 页面。如下图所示：
   ![](https://github.com/tkestack/tke/blob/master/docs/images/tapp-3.png?raw=true)
4. 在 “更新TApp” 页面，编辑 YAML，单击【完成】，即可更新 YAML。如下图所示：
![更新YAML](https://github.com/tkestack/tke/blob/master/docs/images/tapp-4.png?raw=true)

### 调整 Pod 数量
1. 登录 TKEStack，切换到【业务管理】控制台，选择左侧导航栏中的【应用管理】。
2. 选择要变更的业务下相应的命名空间，展开工作负载列表，进入 TApp 管理页面。
3. 点击 TApp 列表操作栏的【更新实例数量】按钮。如下图所示：
   ![](https://github.com/tkestack/tke/blob/master/docs/images/tapp-5.png?raw=true)
...
2. 选择要变更的业务下相应的【命名空间】，展开【工作负载】列表，进入【 TApp】 管理页面，点击进入要灰度升级的 TApp名称。如下图所示：
   ![](https://github.com/tkestack/tke/blob/master/docs/images/tapp-6.png?raw=true)

3. 如下图标签1所示，可选指定需要灰度升级的pod，然后点击下图中标签2 的【灰度升级】即可升级指定pod。

   ![](https://github.com/tkestack/tke/blob/master/docs/images/tapp-7.png?raw=true)
