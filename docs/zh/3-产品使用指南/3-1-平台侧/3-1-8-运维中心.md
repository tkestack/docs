...
#### 新建Helm应用
  ...
  3. 选择相应【集群】，单击【新建】按钮。如下图所示：
      ![新建Helm按钮](.https://github.com/tkestack/tke/blob/master/docs/images/新建Helm按钮.png?raw=true)
  4. 在“新建Helm应用”页面填写Helm应用信息。如下图所示：
      ![新建Helm应用](.https://github.com/tkestack/tke/blob/master/docs/images/新建Helm应用.png?raw=true)
...
![打开日志采集组件](.https://github.com/tkestack/tke/blob/master/docs/images/打开日志采集组件.png?raw=true)
...
#### 新建日志采集规则
  ...
  3. 选择相应【集群】和【命名空间】，单击【新建】按钮。如下图所示：
      ![新建日志采集按钮](.https://github.com/tkestack/tke/blob/master/docs/images/新建日志采集按钮.png?raw=true)
  4. 在“新建日志采集”页面填写日志采集信息。如下图所示：
      ![新建日志采集](.https://github.com/tkestack/tke/blob/master/docs/images/新建日志采集.png?raw=true)
...
#### 设置事件持久化
  ...
  3. 单击列表最右侧【设置】按钮。如下图所示：
      ![事件持久化设置](.https://github.com/tkestack/tke/blob/master/docs/images/事件持久化设置.png?raw=true)
  4. 在“设置事件持久化”页面填写持久化信息。如下图所示：
      ![设置事件持久化](.https://github.com/tkestack/tke/blob/master/docs/images/设置事件持久化.png?raw=true)
     + **事件持久化存储：** 是否进行持久化存储
     + **Elasticsearch地址：** ES 地址，如：http://190.0.0.1:200
     + **索引：** ES索引，最长60个字符，只能包含小写字母、数字及分隔符("-"、"_"、"+")，且必须以小写字母开头
  5. 单击【完成】按钮。
